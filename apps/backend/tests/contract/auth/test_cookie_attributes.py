...
def test_guest_login_sets_cookie_attributes_minimum(client):
    """
    SSOT:
    ...
    r = client.post(url, json={"username": "tester_cookie_attr"})
    assert r.status_code == 200
    assert_is_envelope(r.json(), ok=True, meta_is_null=True)
